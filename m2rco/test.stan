data {
  ...
  int <lower=1> P_partial_county; // number of covariates for partial pooling (county-level effects)
...
transformed parameters {
...

    {
      ...
      for (m in 1:M){
        ...
        Rt[,m] = mu[m] * 2 * inv_logit(-X1 * alpha 

                          -X_partial_county[m] * alpha_county[m] 
